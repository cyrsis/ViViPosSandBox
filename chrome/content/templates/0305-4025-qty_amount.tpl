...
{/if}
192300000480005${item.current_qty + 'x' |right:3}
1;1200100500030${item.name|left:18}
192200100520125${'$' + txn.formatPrice((item.current_subtotal+item.current_discount+item.current_surcharge)/item.current_qty)|left:4}
{if store.county != ''}
