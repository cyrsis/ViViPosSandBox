...
{/if}
1;1200100520006${item.name|left:20}
191300100480009${txn.formatPrice((item.current_subtotal+item.current_discount+item.current_surcharge)/item.current_qty)|right:43}
