...
[0x1B][0x33][0x08]
[&DWON]${item.name|left:14}[&DWOFF][0x1B][0x32]${'$' + txn.formatPrice((item.current_subtotal+item.current_discount+item.current_surcharge)/item.current_qty)|left:8}
[0x1B][0x33][0x18]
[&DWON]${conds|substr:0,24}[&DWOFF]
[&DWON]${conds|substr:24,24}[&DWOFF]
