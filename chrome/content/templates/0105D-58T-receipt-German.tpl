...
--------------------------------
{/if}
${'Netto：'|left:18}${tax.taxable_amount|viviFormatPrices:true|viviFormatTaxes:true|right:13}
${tax.tax.name + '：'|left:18}${tax.included_tax_subtotal|viviFormatTaxes:true|right:13}
[&DHON]${'Amount:'|left:18}${'€' + txn.formatPrice(order.total)|right:13}[&DHOFF]
--------------------------------
