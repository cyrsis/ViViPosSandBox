...
{else}
191290000780010${destination|left:4}
...
{/if}
192290000570010${item.name|left:20}
192200100200005${'$' + txn.formatPrice((item.current_subtotal+item.current_discount+item.current_surcharge)/item.current_qty)|right:26}
191290000370015${condStr.substr(0,18)}
191290000170015${condStr.substr(18,32)}
