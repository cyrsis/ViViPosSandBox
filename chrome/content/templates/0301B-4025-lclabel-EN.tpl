...
{/if}
191200100520010${item.name|left:20}
...
{if store.county != ''}
191100100320008${condStr.substr(0,32)}
191100100150008${condStr.substr(32,64)}
192200100000010${'TEL:' + footnote}
{else}
191200100320008${condStr.substr(0,32)}
191200100150008${condStr.substr(32,64)}
192200100000010${'TEL:' + footnote}
{/if}
