...
{/if}
1;1200100520010${item.name|left:14}
192200100300005${'$' + txn.formatPrice((item.current_subtotal+item.current_discount+item.current_surcharge)/item.current_qty)|right:26}
{if store.county != ''}
1;1200100250008${condStr.substr(0,9)}
1;1200100020008${condStr.substr(9,21)}
{else}
1;0000100330005${condStr.substr(0,9)}
1;0000100170005${condStr.substr(9,21)}
