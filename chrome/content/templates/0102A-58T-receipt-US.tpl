...
{/if}
[&QSON]NO: ${order.seq|tail:2}[&QSOFF]
...
Tax:              ${txn.formatPrice(order.tax_subtotal)|right:14}
{/if}
--------------------------------
{/if}
{eval}
...
{/eval}
${'subtotal：'|left:18}${tax.taxable_amount|viviFormatPrices:true|viviFormatTaxes:true|right:14}
${'Sales Tax：'|left:18}${tax.included_tax_subtotal|viviFormatTaxes:true|right:14}
${'Amount:'|left:18}${txn.formatPrice(order.total)|right:14}
--------------------------------
${'**** payment ****'|center:32}
...
{if customer != null}
--------------------------------
Name: ${customer.name + ' (' + customer.customer_id + ')'|left:26}
