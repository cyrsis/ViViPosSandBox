...
[0x1C][0x28][0x4C][0x02][0x00][0x43][0x30]${order.seq + (order.check_no != null && order.check_no.length > 0 ? ' (' + order.check_no + ')' : '')|left:19}${counter++ + '/' + total|right:5}
[0x1B][0x33][0x08]
...
{/for}
{/for}
[0x1C][0x28][0x4C][0x02][0x00][0x42][0x30]