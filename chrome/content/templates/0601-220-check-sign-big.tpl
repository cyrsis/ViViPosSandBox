{if hasLinkedItems}
{if destination_prefix == 1211 || destination_prefix == 1212 || destination_prefix == 1221 || destination_prefix == 1222 || destination_prefix == 2211 || destination_prefix == 2212 || destination_prefix == 2221 || destination_prefix == 2222}
[&INIT]
{eval}
...
[&CR]
[&QSON]${order.destination|default:'內用'}:${order.seq|tail:3}[&QSOFF]{if order.table_name != 0}  [&QSON]桌名:${table_name}[&QSOFF]{/if}
[&CR]
